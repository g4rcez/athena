...
const schema = {
	username: [regex.string, regex.brazilianName, regex.number],
};
const validate = regex.validate({ username: 'Allan Garcez' }, schema);
console.log('Leap 12/31/1996', regex.leapYear('12/31/1996'));
console.log('Leap 12/31/1997', regex.leapYear('12/31/1997'));
console.log('Is array:', regex.array([5, 3, 43, 12312]));
console.log('Is array:', regex.array({}));
console.log('Is float:', regex.float(121312.4));
console.log('Is float:', regex.empty(121312));
[
...
console.log('070.680.938-68 ' + regex.cpf('070.680.938-68'));
